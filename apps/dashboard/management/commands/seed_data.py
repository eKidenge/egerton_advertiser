...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # SUMMARY
        # ============================================
        self.stdout.write(self.style.SUCCESS('✅ Client database setup complete!'))
        ...
        self.stdout.write('   |-------------|---------------|--------------|')
        self.stdout.write(f'   | admin       | Super Admin   | Admin@123!   |')
        self.stdout.write(f'   | adminuser   | Admin         | Admin@123!   |')
        self.stdout.write(f'   | editor      | Editor        | Editor@123!  |')
        self.stdout.write(f'   | journalist  | Journalist    | Journalist@123!|')
        self.stdout.write(f'   | subscriber  | Subscriber    | Subscriber@123!|')
        self.stdout.write(f'   | advertiser  | Advertiser    | Advertiser@123!|')
        self.stdout.write('   ========================================')
        ...
        self.stdout.write('\n✅ Database is clean and ready for client use!')
